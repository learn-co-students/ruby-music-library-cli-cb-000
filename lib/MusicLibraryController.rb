class MusicLibraryController
  ...
  def list_artists
    Artists.sorted.each_with_index{|artist, index| puts "#{index+1}. #{artist.name}"}
  end

  def list_genres
    Genres.sorted.each_with_index{|genre, index| puts "#{index+1}. #{genre.name}"}
  end
